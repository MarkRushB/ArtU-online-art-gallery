...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container-fluid">
		<div class="row">
			<!-- 控制栏 -->
			<div class="col-md-1 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">Edward Hopper<span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">Claude Monet</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">Salvador Dalí</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">Vincent van Gogh</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">Paul Cézanne</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">Pablo Picasso</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">Peter Paul Rubens</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>ArtU</h1>
					<p>ArtU is an online art gallery</p>
				</div>
