        ...
        for(var i=0;i<allShoppingRecords.length;i++){
            ...
            if(allShoppingRecords[i].orderStatus == 0){
                ...
                transportHTMLTemp+= '<tr>'+
                        ...
                        '<td>'+orderArray[allShoppingRecords[i].orderStatus]+'</td>'+
                        '<td>'+
                        '<button class="btn btn-primary btn-sm" onclick="receiveProducts('+allShoppingRecords[i].userId+','+allShoppingRecords[i].productId+',\''+allShoppingRecords[i].time+'\')">Confirm</button>'+
                        '</td>'+
                        '</tr>';
                transportCounts++;
            }
